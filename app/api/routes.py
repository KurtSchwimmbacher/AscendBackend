...
async def detect(
    ...
    try:
        ...
        # 4. Run YOLO inference using service layer
...
# ------------------------------
# Select Single Coloured Route (Stub)
# ------------------------------
@api_router.post("/routes/select-colour")
async def select_coloured_route():
    """
    Select a single coloured route from detections.

    Note: This is a stub endpoint. Implementation will be added later.
    """
    ...
